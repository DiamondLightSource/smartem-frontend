...
export const deleteGridGridsGridUuidDelete = (
  ...
  return customInstance<void>({ url: `/grids/${gridUuid}`, method: 'DELETE', signal }, options)
}
...
export const deleteAtlasAtlasesAtlasUuidDelete = (
  ...
  return customInstance<void>({ url: `/atlases/${atlasUuid}`, method: 'DELETE', signal }, options)
}
