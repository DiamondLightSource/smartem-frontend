...
import { getGridGridsquaresGridsGridUuidGridsquaresGet } from '../api/generated/default/default'
import type {
  GridSquareResponse,
      ...
      <Stack direction="row" spacing={2}>
        <Container maxWidth="sm" content="center" style={{ width: '100%', paddingTop: '50px' }}>
          <Card variant="outlined">
            ...
            >
              <img src={`${url}/grids/${gridId}/atlas_image`} alt="Grid atlas" />
            ...
            <CardActions>
              ...
              {selectedSquare ? (
                <IconButton
                  ...
                  onClick={() =>
                    navigate({
                      to: '/acquisitions/$acqId/grids/$gridId/squares/$squareId',
                      params: { acqId, gridId, squareId: selectedSquare },
                    })
                  }
                >
                  <ZoomInIcon />
...
export const Route = createFileRoute('/acquisitions/$acqId/grids/$gridId/atlas')({
  component: Atlas,
})
