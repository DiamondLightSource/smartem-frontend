...
import type { QualityPrediction } from '@smartem/api'
...
function QualityPredictionsForSquare() {
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      ...
      const holePredictionsResponse = await fetch(
        `${apiUrl()}/gridsquares/${squareId}/foilhole_quality_predictions`
      )
  ...
  const handleChange = async (event: SelectChangeEvent) => {
    ...
    const holePredictionsResponse = await fetch(
      `${apiUrl()}/quality_metric/${event.target.value}/gridsquares/${squareId}/foilhole_quality_predictions`
    )
...
export const Route = createFileRoute(
  ...
  component: QualityPredictionsForSquare,
})
