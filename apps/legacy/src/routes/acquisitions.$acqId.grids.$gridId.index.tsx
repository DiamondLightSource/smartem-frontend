...
import type { FoilHoleResponse, GridSquareResponse } from '@smartem/api'
import {
          ...
          <IconButton
            onClick={() =>
              navigate({
                ...
                params: { acqId, gridId, squareId: square.uuid },
              })
            }
          >
            <InsightsIcon />
...
export const Route = createFileRoute('/acquisitions/$acqId/grids/$gridId/')({ component: Grid })
